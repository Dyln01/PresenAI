...
favicon.rel = 'icon';
favicon.href = '/images/mini_logo.png';
            ...
            if (!$)
              if (t.type.indexOf("touch") > -1) {
                if (t.touches && t.touches.length > 0)
                  if (((Ke[0] = Ve(t.touches[0], Ge)), t.touches.length > 1))
              ...
              if (!re || "mousedown" !== t.type) {
                ...
                if (!ye && a > 1 && !_e && !ve)
                  (_ = x),
                    ...
                    wt(jt, o[1]),
                    Ye(Wt, jt, Ee),
                    (Ae.x = Math.abs(Ee.x) - y.x),
                    (Ae.y = Math.abs(Ee.y) - y.y),
                    (we = be = Re(Wt, jt));
              }
            }
          },
                ...
                if (l >= c[E].frame && l <= c[E + 1].frame) {
                  ...
                  for (_ in T.props)
                    if (s.call(T.props, _)) {
                      ...
                      if (
                        ((k = T.props[_].easing(k)),
                        (A = dt(T.props[_].value, I.props[_].value, k)),
                        (A = ht(A)),
                        0 === _.indexOf("@"))
                      )
                        u.setAttribute(_.substr(1), A);
...
*/
          ...
          (bt = N(function (t, e, n, i, o) {
            ...
            if (!(p = _(t, "lazybeforeunveil", e)).defaultPrevented) {
              ...
              if (
                ...
                clearTimeout(V), (V = h(ct, 2500)), x(t, gt, true);
              ...
              for (var S = 1; S <= C; S++) {
                ...
                T && !M && (F += " qs-event"),
                  ...
                  (l[+E] ||
                    ...
                    !M &&
                    (F += " qs-disabled"),
                  +v(new Date()) == +E && (F += " qs-current"),
                  +E === m && g && P && (F += " qs-range-start"),
                  +E > m && +E < g && (F += " qs-range-middle"),
                  +E === g && m && P && (F += " qs-range-end"),
                  M && ((F += " qs-empty"), (L = "")),
                  q.push(
                    '<div class="' +
                      F +
  ...
  10955: function (t, e, n) {
    ...
    (t.exports = i),
      ...
      (i.prototype.injectIframe = function t(e, n, product) {
        ...
        o(
          '<iframe frameborder="0" style="width: 100%; min-height: 100%;"></iframe>'
        ).appendTo(u);
    ...
    (t.exports = i),
      (i.prototype.generate = function t() {
        ...
        return (
          ...
          (e = this.replaceAll(e, "[REFERENCE_ID]", this.computeReferenceId())),
          (e = this.replaceAll(e, "[NAME]", this.product.title)),
          (e = this.replaceAll(e, "[DESCRIPTION]", this.product.desc || "")),
          (e = this.replaceAll(e, "[SKU]", this.product.sku || "")),
          (e = this.replaceAll(e, "[VALUE]", this.product.price)),
          (e = this.replaceAll(e, "[CURRENCY]", this.product.currency)),
          (e = this.replaceAll(e, "[SESSION_ID]", this.paymentConfig.sessionId))
        );
      }),
  ...
  20: function (t, e, n) {
    ...
    }).call(e, n(104), n(300).setImmediate, n(48), n(49).Buffer);
  },
  215: function (t, e, n) {
    "use strict";
    function i() {
  ...
  2983: function (t, e, n) {
    ...
    (t.exports = i),
      (i.prototype.orderApproved = function t() {
        this.displayMessage(
          "Your order has been approved. Thank you!",
          "payment-success"
        );
      }),
      ...
      (i.prototype.productError = function t() {
        this.displayMessage(
          "Set the Name, Price, and Currency for the Product.",
          "payment-error"
        );
      }),
  ...
  502: function (t, e, n) {
    "use strict";
    var i = n(225).instance();
    i.registerAnimation(n(503)),
      i.registerAnimation(n(506)),
      i.registerAnimation(n(226));
  },
  503: function (t, e, n) {
    "use strict";
    function i(t, e) {
            ...
            return (
              ...
              (e.to = function t(index) {
                ...
                if (!(index > this._items.length - 1 || index < 0)) {
                  if (this._isSliding)
                    return (
                      s["default"](this._element).one(T, function () {
                        return e.to(index);
                      }),
                      void 0
                    );
